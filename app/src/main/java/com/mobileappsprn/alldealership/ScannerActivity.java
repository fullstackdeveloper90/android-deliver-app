 ...
 */
public class ScannerActivity extends Activity implements View.OnClickListener, ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityRef = ScannerActivity.this;
        takeCameraPermission();
        Log.v("FLOW", "CAME HERE : ScannerActivity");
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (!rawResult.getText().toString().equalsIgnoreCase(null) &&
                    ...
                    Intent intent = new Intent(ScannerActivity.this, QRScannerWebViewActivity.class);
