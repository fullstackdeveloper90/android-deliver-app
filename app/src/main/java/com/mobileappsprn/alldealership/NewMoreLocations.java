...
public class NewMoreLocations extends Activity implements OnItemClickListener {
    TextView textView;
    ListView listView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("FLOW", "CAME HERE : NewMoreLocations");
        textView = (TextView) findViewById(R.id.textView1);
        listView = (ListView) findViewById(R.id.list);
        listView.setOnItemClickListener(this);

        titleHeader = (TextView) findViewById(R.id.addNewVehicle);

        if(! GlobalState.isVariantTcc){
            titleHeader.setText("Preferred Dealer");
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view,
        ...
        MoreLocations.flag = "temp";
        Intent intent = new Intent(NewMoreLocations.this, ContactUsListView.class);
        intent.putExtra("tag", AppConstants.CONTACTS);
        intent.putExtra("title", GlobalState.homeMenuItems.get(position).getDisplay());//menuItems.get
        //Toast.makeText(NewMoreLocations.this,"2"+GlobalState.homeMenuItems.get(position).getTitle(),Toast.LENGTH_SHORT).show();

        String phn = GlobalState.homeMenuItems.get(position).getPhoneno();
        GlobalState.tempdealershipPhone = phn;
        GlobalState.templocationName = GlobalState.homeMenuItems.get(position).getTitle();
